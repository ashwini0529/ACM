...
<body>
  ...
  <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" id="register-form" novalidate>
  
    <div class="label">Name</div><input type="text" id="name" name="name" value="<?php echo $name; ?>" /><br />
    <div class="label">Gender</div><select id="gender" name="gender" />
     <option value="Female">Female</option>
     <option value="Male">Male</option>
                                      <option value="Other">Other</option>
                                   </select><br />
    <div class="label">Address</div><input type="text" id="address" name="address" value="<?php echo $address; ?>" /><br />
    <div class="label">Email</div><input type="text" id="email" name="email" value="<?php echo $email; ?>" /><br />
    <div class="label">Username</div><input type="text" id="username" name="username" value="<?php echo $username; ?>" /><br />
